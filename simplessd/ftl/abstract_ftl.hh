...
class AbstractFTL : public StatObject {
 protected:
  ...
  ESPRESSO::ESPRESSO *pESPRESSO;

  // ESTODO: merge two dram
 ...
 public:
  AbstractFTL(Parameter &p, PAL::PAL *l, ESPRESSO::ESPRESSO *pe, DRAM::AbstractDRAM *d, DRAM::RemoteDRAM * rd, CPU::CPU *pCPU)
      : param(p), pPAL(l), pESPRESSO(pe), pDRAM(d), pRemoteDRAM(rd), pCPU(pCPU) {}
  virtual ~AbstractFTL() {}
  ...
  // remote
  virtual void submitRemotePALReq(PAL::Request &, uint64_t &) = 0;
  virtual void triggerRemoteUpdateSubmit() = 0;
  virtual void commitRemotePALReq(PAL::Request &) = 0;
  virtual void commitRemoteFTLReq(PAL::Request) = 0;
  virtual bool conductRemoteFTLMapFind(uint64_t, uint64_t &, void *, bool) = 0;
  virtual bool conductRemoteFTLBlocksFind(uint32_t, void *) = 0;
  virtual void conductRemoteFTLMapModify(uint64_t, uint64_t &) = 0;
  virtual void conductRemoteFTLMapEmplaceEmpty(uint64_t) = 0;
  virtual bool conductRemoteFTLGetBlockToWrite(uint32_t, void *) = 0;

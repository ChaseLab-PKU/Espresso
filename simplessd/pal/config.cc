...
Config::Config() {
  ...
  nandTiming.lsb.read = 30000000;    // 30us
  nandTiming.lsb.write = 200000000;  // 200us
  nandTiming.csb.read = 45000000;    // 45us
  nandTiming.csb.write = 280000000; // 280us
  nandTiming.msb.read = 60000000;     // 60us
  nandTiming.msb.write = 400000000;  // 400us
  nandTiming.erase = 3000000000;      // 3ms

...
namespace ESPRESSO {class ESPRESSO;}
...
class PRPList : public DMAInterface {
 ...
 public:
  PRPList(ConfigData &, DMAFunction &, void *, uint64_t, uint64_t, uint64_t, CPU::CPU *);
  PRPList(ConfigData &, DMAFunction &, void *, uint64_t, uint64_t, bool, CPU::CPU *);
  ~PRPList();

  void read(uint64_t, uint64_t, uint8_t *, DMAFunction &,
            void * = nullptr, bool = false) override;
...
class SGL : public DMAInterface {
 ...
 public:
  SGL(ConfigData &, DMAFunction &, void *, uint64_t, uint64_t, CPU::CPU *);
  ~SGL();

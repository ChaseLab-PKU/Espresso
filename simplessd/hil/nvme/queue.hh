...
typedef struct _SQEntryWrapper {
  ...
  _SQEntryWrapper(SQEntry &, uint16_t, uint16_t, uint16_t, uint16_t, bool=false, bool=false, uint8_t=0xFF, uint8_t=0xFF);
} SQEntryWrapper;
...
class CQueue : public Queue {
 ...
 public:
  CQueue(uint16_t, bool, bool, uint16_t, uint16_t);

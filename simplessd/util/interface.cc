...
static const uint32_t internalDelay[PCIE_NUM] = {19, 70, 115, 115, 115, 115};      // Symbol
static const float encoding[PCIE_NUM] = {1.25f, 1.25f,
                                 1.015625f, 1.015625f, 1.015625f, 1.0f};  // Ratio
static const uint32_t delay[PCIE_NUM] = {3200, 1600, 1000, 500, 250, 125};  // pico-second
...
uint64_t calculatePhyLoad(uint64_t bytesize) {
  uint64_t nTLP = MAX(DIVCEIL(bytesize, maxPayloadSize), 1);
  uint64_t nSymbol;

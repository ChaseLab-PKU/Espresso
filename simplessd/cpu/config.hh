...
class Config : public BaseConfig {
 private:
  ...
  // Mode 0: each layer has its own core
  // Mode 1: NVMe Ctrl, General Core, and ECC
  uint8_t mode;
  
  bool useHostCPU;  //!< Default: false

  uint32_t hilCore;  //!< Default: 1
  uint32_t iclCore;  //!< Default: 1
  uint32_t ftlCore;  //!< Default: 1
  uint32_t eccCore;  //!< Default: 1
  uint32_t espressoCore;  //!< Default: 1

  uint32_t nvmeCore;  //!< Default: 1
  uint32_t generalCore;  //!< Default: 1
